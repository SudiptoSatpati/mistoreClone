...
const iconArray = [
  {
    icon: repeatIcon,
    para1: "Hassle-free replacement",
    para2: "10-day easy replacement policy on mi.com",
  },
  {
    icon: shieldIcon,
    para1: "100% secure payments",
    para2: "We support Cards, Wallets, EMI and COD",
  },
  {
    icon: mapIcon,
    para1: "Vast service network",
    para2: "1000 Mi service-centers across 600 cities",
  },
];
